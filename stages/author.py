...
class Author:
    ...
    def run(self):
        ...
        if self.scene_during >= AUTHOR_TIME:
            ...
            font_surf_5 = sys_font.render(CHRISTIAN, True, 'white')
            ...
            font_rect_5 = font_surf_5.get_rect(center=(WINDOW_WIDTH // 2, 650))
            ...
            if self.scene_during < 5000:
                ...
                font_surf_5.set_alpha(int(self.scene_during / 1000 * 0.4))
            ...
            self.display_surface.blit(font_surf_5, font_rect_5)
